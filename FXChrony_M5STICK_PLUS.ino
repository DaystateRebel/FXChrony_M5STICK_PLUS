...
void calculate_roll(bool override)
{
  ...
  if((old_average != new_average) || override) {
    ...
    M5.Lcd.fillTriangle(0, 68-old_average, 20, 60-old_average, 20, 77-old_average, TFT_BLACK);
    M5.Lcd.fillTriangle(0, 68-new_average, 20, 60-new_average, 20, 77-new_average, tri_colour);
